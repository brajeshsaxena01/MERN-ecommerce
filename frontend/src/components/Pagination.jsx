...
import { fetchFilterSortPaginationData } from "../redux/Products/action";
...
export const Pagination = ({ handlePage, page, totalItems }) => {
  // const [page, setPage] = useState(1);
  // // const totalItems = useSelector(
  // //   (store) => store.ecommerceData.products.length
  // // );
  // const totalItems = 30;
